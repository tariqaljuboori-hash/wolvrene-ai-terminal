      ...
      <div className={fullscreen ? "w-full max-w-[1800px] mx-auto" : "w-full max-w-7xl mx-auto"}>
        ...
        {aiOpen && (
          <div className="fixed inset-0 bg-black/75 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-[#111116] border border-[#302817] rounded-2xl w-full max-w-6xl h-[88vh] overflow-hidden shadow-[0_0_55px_rgba(216,155,0,0.22)]">
              <div className="flex items-center justify-between border-b border-zinc-800 px-5 py-4">
                <div>
                  <h2 className="text-2xl font-black tracking-wide" style={{ color: gold, textShadow: "0 0 14px rgba(216,155,0,0.45)" }}>
                    WOLVRENE AI COMMAND — LIVE BRAIN
                  </h2>
                  <p className="text-xs text-gray-500">Live context brain · {timeframe} · {session} · {bias} · Orders {orders.length} · Alerts {alerts.length}</p>
                </div>
                <button onClick={() => setAiOpen(false)} className="text-2xl text-gray-400 hover:text-white">×</button>
              </div>

              <div className="grid lg:grid-cols-[minmax(0,1fr)_330px] h-[calc(88vh-73px)] overflow-hidden">
                <div className="min-w-0 flex flex-col">
                  ...
                  <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain p-4 scroll-smooth">
                    {aiTab === "chat" && (
                ...
                <div className="border-l border-zinc-800 bg-black/35 p-4 space-y-3 overflow-y-auto overscroll-contain">
                  ...
                  <div className="rounded-2xl border border-yellow-700/25 bg-yellow-500/5 p-4">
                    ...
                    <p className="text-xs leading-5 text-gray-400">Patch 6.1: live context is now structured and scroll-safe. This reads timeframe, session, bias, price, orders, alerts, funding, and selected trade before answering.</p>
                  </div>
                </div>
              </div>
            </div>
