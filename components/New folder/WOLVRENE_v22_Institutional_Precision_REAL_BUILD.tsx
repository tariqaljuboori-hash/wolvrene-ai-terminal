...
// WOLVRENE v22 Institutional Precision Build
// Real upgrade over v21: institutional conflict filter, precision score engine,
// stricter elite gating, cleaner lifecycle replacement, stronger session weighting,
// reduced cancelled/noise labels, and clearer AI/Discord reasoning.
...
export default function WolvreneTerminal() {
  ...
  function buildCompactDiscordSignal(label = "WOLVRENE SIGNAL") {
    ...
    return [
      ...
      `Decision: ${visualIntelligence.lastDecisionAction} · Institutional: ${institutionalPrecision.institutionalGrade} ${institutionalPrecision.precisionScore}% · Visual: ${visualIntelligence.summary}`,
  ...
  }, [livePrice, timeframe, session, sessionCountdown, bias, wolfMode, confidence, signalPlan, decisionPlan, structureState, liquidityState, triggerValidation, visualIntelligence, institutionalPrecision, managementBrain, marketStats, candlesSummary, backtestStats, learningWeights, orders, alerts, selectedOrder]);
  ...
  useEffect(() => {
    ...
    if (!institutionalPrecision.eliteAllowed) return;
    if (decisionPlan.quality < Math.max(86, externalAlertSettings.minSignalConfidence)) return;
