...
// WOLVRENE v25.1 Last Polish Stable — FIXED
...
export default function WolvreneTerminal() {
  ...
  const v25FinalBrain = useMemo(() => {
    ...
    const displayDirection = finalDirection || (action === "CANCELLED" ? null : null);
    const displayBias =
    ...
    return {
      ...
      directionColorClass: displayBias === "LONG" ? "font-bold text-green-400" : displayBias === "SHORT" ? "font-bold text-red-400" : displayBias === "CANCELLED" ? "font-bold text-gray-400" : "font-bold text-yellow-400",
      ...
      <div className={fullscreen ? "w-full max-w-[1800px] mx-auto" : "w-full max-w-7xl mx-auto"}>
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <p className="text-gray-500 text-xs tracking-wide">BTC AI Dashboard v25.1 — Last Polish Stable</p>
          </div>
              ...
              >
                ...
                <div className="absolute left-3 top-3 z-40 max-w-[360px] rounded-2xl border border-yellow-500/20 bg-black/70 p-3 backdrop-blur-md shadow-[0_0_30px_rgba(0,0,0,0.65)] pointer-events-none">
                  <div className="flex items-center justify-between gap-3">
                    <p className="text-[10px] font-black tracking-[0.18em] text-yellow-400">v25.1 LAST POLISH</p>
                  ...
                  <p className="mt-1 text-[10px] text-gray-500">Final sync · direction fixed · entry quality · clean alerts · stable release</p>
                </div>
            ...
            <aside className="space-y-4 min-w-0">
              <div className={`${card} p-5`}>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[10px] px-2 py-1 rounded-full border border-yellow-600/40 text-yellow-500 bg-yellow-500/10">V25.1</span>
                </div>
