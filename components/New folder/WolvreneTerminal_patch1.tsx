        ...
        >
          ...
          {onDelete && (
            <button
              ...
              className="hidden group-hover:block rounded-md bg-red-600 px-2 py-1 text-[10px] font-bold text-white hover:bg-red-500"
            >
              ×
            </button>
          )}
      ...
      <div className={fullscreen ? "w-full max-w-[1800px] mx-auto" : "w-full max-w-7xl mx-auto"}>
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <p className="text-gray-500 text-xs tracking-wide">BTC AI Dashboard v15.5 — Smart Execution Layer</p>
          </div>
