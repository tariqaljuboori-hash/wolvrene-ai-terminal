...
// WOLVRENE v30 Clean Core Elite — FULL STABLE BUILD
// Clean dashboard text, fixed final direction sync, reduced chart noise, stored stable signals, cleaned AI/Decision labels, and tightened execution display.
...
export default function WolvreneTerminal() {
  ...
  const visualIntelligence = useMemo(() => {
    ...
    return {
      markers: markers.filter((marker) => marker.kind === "DECISION" || marker.kind === "BOS" || marker.kind === "CHOCH" || marker.kind === "SWEEP").slice(-14),
      zones: zones.slice(-4),
  ...
  useEffect(() => {
    ...
    const shouldMark = Boolean(direction && markerTime && markerPrice && maturePhase);
    ...
    setSignalMarkers((prev) => {
      ...
      return [...cleaned, nextMarker].slice(-8);
    });
      ...
      <div className={fullscreen ? "w-full max-w-[1800px] mx-auto" : "w-full max-w-7xl mx-auto"}>
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <p className="text-gray-500 text-xs tracking-wide">BTC AI Dashboard — Clean Core Elite</p>
          </div>
              ...
              >
                ...
                <div className="absolute left-3 top-3 z-40 max-w-[360px] rounded-2xl border border-yellow-500/20 bg-black/70 p-3 backdrop-blur-md shadow-[0_0_30px_rgba(0,0,0,0.65)] pointer-events-none">
                  <div className="flex items-center justify-between gap-3">
                    <p className="text-[10px] font-black tracking-[0.18em] text-yellow-400">WOLVRENE CLEAN CORE</p>
