...
// WOLVRENE v35 INSTITUTIONAL AI PRO — REAL FULL INTEGRATION
// Auto Learning, Live Trade Management, Smart Dynamic TP/SL, Journal Auto Close, Real Accuracy Tracking, Session Sniper, MTF + AI Signal Elite, and Level 2 dashboard panels.
...
export default function WolvreneTerminal() {
  ...
  const [terminalTab, setTerminalTab] = useState<"dashboard" | "analytics" | "journal" | "backtest" | "pro">("dashboard");
            ...
            {terminalTab === "analytics" && (
              <div>
                ...
                <div className="grid gap-3 text-sm md:grid-cols-4">
                  ...
                  <div className="rounded-xl border border-zinc-800 bg-black/40 p-3"><p className="text-gray-500">Real Win Rate</p><p className="text-2xl font-black text-green-400">{eliteAnalytics.winRate}%</p></div>
                  <div className="rounded-xl border border-zinc-800 bg-black/40 p-3"><p className="text-gray-500">Best Session</p><p className="text-lg font-black text-cyan-400">{eliteAnalytics.bestSession}</p></div>
                  <div className="rounded-xl border border-zinc-800 bg-black/40 p-3"><p className="text-gray-500">Learning</p><p className="text-2xl font-black text-yellow-400">{eliteAnalytics.learningTotal}</p></div>
                  <div className="rounded-xl border border-zinc-800 bg-black/40 p-3"><p className="text-gray-500">Noise</p><p className={eliteAnalytics.noiseWarning ? "text-2xl font-black text-red-400" : "text-2xl font-black text-green-400"}>{eliteAnalytics.noiseWarning ? "ON" : "OFF"}</p></div>
                </div>
              </div>
            )}
              ...
              <div>
                ...
                <div className="grid gap-3 text-sm md:grid-cols-3">
                  ...
                  <div className="rounded-xl border border-zinc-800 bg-black/40 p-3">
                    ...
                    <p className={liveTradeManagement.exitWarning ? "text-xl font-black text-red-400" : "text-xl font-black text-green-400"}>{liveTradeManagement.status}</p>
