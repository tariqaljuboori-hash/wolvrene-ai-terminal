...
// WOLVRENE v23 Elite Institutional Engine
...
export default function WolvreneTerminal() {
  ...
  function buildCompactDiscordSignal(label = "WOLVRENE SIGNAL") {
    ...
    return [
      ...
      `Decision: ${visualIntelligence.lastDecisionAction} · v23: ${v23EliteEngine.sniperGrade} ${v23EliteEngine.sniperScore}% · Trigger: ${v23EliteEngine.triggerSyncStatus}`,
  ...
  }, [livePrice, timeframe, session, sessionCountdown, bias, wolfMode, confidence, signalPlan, decisionPlan, structureState, liquidityState, triggerValidation, visualIntelligence, institutionalPrecision, v23EliteEngine, managementBrain, marketStats, candlesSummary, backtestStats, learningWeights, orders, alerts, selectedOrder]);
  ...
  useEffect(() => {
    ...
    if (decisionPlan.quality < Math.max(88, externalAlertSettings.minSignalConfidence) || v23EliteEngine.sniperScore < 92) return;
              ...
              >
                ...
                <div className="absolute left-3 top-3 z-40 max-w-[360px] rounded-2xl border border-yellow-500/20 bg-black/70 p-3 backdrop-blur-md shadow-[0_0_30px_rgba(0,0,0,0.65)] pointer-events-none">
                  <div className="flex items-center justify-between gap-3">
                    <p className="text-[10px] font-black tracking-[0.18em] text-yellow-400">v23 ELITE INSTITUTIONAL</p>
                  ...
                  <p className="mt-2 text-[11px] text-gray-300">{v23EliteEngine.summary}</p>
                  <p className="mt-1 text-[10px] text-gray-500">{visualIntelligence.summary}</p>
                  <p className="mt-1 text-[10px] text-gray-500">Trigger sync · label spacing · heat zones · sniper-only elite alerts</p>
                </div>
